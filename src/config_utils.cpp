...
void ConfigUtils::initUnsetPropertiesWithDefaults(Config& config)
{
    ...
    INIT_UNSET_PROPERTY(config.animationOptions, gridGradientColorC, GRID_GRADIENT_COLOR_C);
    ...
    INIT_UNSET_PROPERTY(config.animationOptions, gridGradientSpeed, static_cast<GridGradientSpeed>(GRID_GRADIENT_SPEED));
    ...
    INIT_UNSET_PROPERTY(config.addonOptions.analogOptions, smoothing_factor_min, !!SMOOTHING_FACTOR);
    INIT_UNSET_PROPERTY(config.addonOptions.analogOptions, smoothing_factor_max, !!SMOOTHING_FACTOR);
    ...
    INIT_UNSET_PROPERTY(config.addonOptions.analogOptions, smoothing_factor2_min, !!SMOOTHING_FACTOR2);
    INIT_UNSET_PROPERTY(config.addonOptions.analogOptions, smoothing_factor2_max, !!SMOOTHING_FACTOR2);
    ...
    INIT_UNSET_PROPERTY(config.addonOptions.analogOptions, x_min, 0);
    INIT_UNSET_PROPERTY(config.addonOptions.analogOptions, x_max, 4095);
    INIT_UNSET_PROPERTY(config.addonOptions.analogOptions, y_min, 0);
    INIT_UNSET_PROPERTY(config.addonOptions.analogOptions, y_max, 4095);
    INIT_UNSET_PROPERTY(config.addonOptions.analogOptions, x_min2, 0);
    INIT_UNSET_PROPERTY(config.addonOptions.analogOptions, x_max2, 4095);
    INIT_UNSET_PROPERTY(config.addonOptions.analogOptions, y_min2, 0);
    INIT_UNSET_PROPERTY(config.addonOptions.analogOptions, y_max2, 4095);
